 ...
 * overwrites the method based on wanting to write Bold Text.
 */
...
public class BoldText extends TextDecorator
{
    ...
    @Override
    /**
     * Overwrites the baseTexts default action by adding on the BoldText markup
     * modifiers
     */
    public String getText()
    {
        return "<b>" + baseText.getText() + "</b>";
    }
